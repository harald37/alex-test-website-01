    ...
    <div className="bg-surface pt-32 md:pt-40 pb-24">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-center mb-32">
          ...
          >
            <h1 className="font-sans uppercase tracking-[0.3em] text-[10px] text-zinc-400 mb-4 block">Über mich</h1>
            <h2 className="text-4xl md:text-6xl font-serif mb-8 text-zinc-900 leading-tight">Hi, ich bin Alex.</h2>
