      ...
      <section className="max-w-3xl mx-auto">
        ...
        <div className="space-y-12 text-zinc-600 text-base md:text-lg leading-relaxed tracking-wide">
          ...
          <div>
            ...
            <h3 className="font-sans uppercase tracking-[0.1em] text-[10px] text-zinc-900 mt-4 mb-2">Wie erfassen wir deine Daten?</h3>
            <p>
              Deine Daten werden zum einen dadurch erhoben, dass du uns diese mitteilst. Hierbei kann es sich z. B. um Daten handeln, die du in ein Kontaktformular eingeben. Andere Daten werden automatisch oder nach deiner Einwilligung beim Besuch der Website durch unsere IT-Systeme erfasst.
            </p>
          </div>
          ...
          <div>
            <h2 className="font-sans uppercase tracking-[0.2em] text-xs text-zinc-900 mb-4">5. Deine Rechte</h2>
            <p>
