...
export const Braunschweig = () => {
  ...
  const faqs = [
    {
      q: "Begleitest du Hochzeiten in ganz Braunschweig?",
      a: "Ja, ich begleite Hochzeiten in der gesamten Löwenstadt Braunschweig sowie in der Umgebung (z.B. Wolfenbüttel, Salzgitter, Peine)."
    },
    {
      q: "Kennst du gute Locations in Braunschweig?",
      a: "Natürlich. Vom Braunschweiger Dom über das Schloss Richmond bis hin zu modernen Locations im Westpark – Braunschweig bietet fantastische Kulissen."
    },
    {
      q: "Bietest du auch Kennenlern-Shootings an?",
      a: "Ja, sehr gerne. Ein Engagement-Shooting in der Braunschweiger Altstadt ist eine tolle Möglichkeit, sich vor der Kamera einzuspielen."
    },
    {
    ...
    <main className="bg-[#f5f2ed] min-h-screen">
      ...
      <section className="pt-48 md:pt-64 pb-24 px-6 md:px-12 max-w-screen-2xl mx-auto">
        <div className="max-w-4xl">
          <span className="font-sans uppercase tracking-[0.4em] text-[9px] text-[#141414]/40 mb-8 block">Region Braunschweig</span>
          <h1 className="font-serif italic text-5xl md:text-8xl lg:text-9xl text-[#141414] leading-none tracking-tight mb-16">
            Hochzeitsfotograf <br className="hidden md:block" /> Braunschweig.
          </h1>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-8">
              ...
              <p className="text-[#141414]/70 text-base md:text-lg leading-relaxed tracking-wide">
                Als euer Hochzeitsfotograf in Braunschweig begleite ich euch an eurem besonderen Tag. Ob im Braunschweiger Dom, im Schloss Richmond oder in einer der vielen charmanten Locations in der Region – ich halte eure emotionalsten Momente in zeitlosen Bildern fest.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white py-32 px-6 md:px-12">
        <div className="max-w-screen-2xl mx-auto grid md:grid-cols-2 gap-24 items-center">
          <div className="aspect-[3/4] overflow-hidden rounded-[3rem] md:order-last">
            <img 
              src={IMAGES.ABOUT} 
              alt="Alex Begopoulos" 
      ...
      <section className="py-32 px-6 md:px-12 max-w-screen-2xl mx-auto">
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="font-serif italic text-4xl md:text-6xl text-[#141414] leading-tight mb-16 text-center">Kurz & Knapp für Braunschweig.</h2>
