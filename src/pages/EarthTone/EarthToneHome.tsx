...
export const EarthToneHome: React.FC = () => {
  return (
    <div className="flex flex-col bg-[#f5f2ed] text-[#141414]">
      ...
      <section className="relative h-[100svh] flex flex-col items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 w-full h-full flex flex-col items-center md:items-start justify-end text-center md:text-left px-6 md:px-24 pb-24 md:pb-32">
          ...
          >
            ...
            <button className="bg-white text-black px-10 py-5 rounded-full text-[10px] uppercase tracking-[0.3em] font-bold hover:scale-105 transition-transform">
              Termin anfragen
            </button>
          </motion.div>
        </div>
      ...
      <section className="py-32 md:py-48 px-6 md:px-24 flex flex-col items-center">
        <div className="max-w-5xl w-full text-center">
          <span className="font-sans uppercase tracking-[0.4em] text-[10px] text-[#141414] mb-12 block">Meine Philosophie</span>
          ...
          <div className="grid md:grid-cols-3 gap-12 md:gap-24 mb-24 text-left">
            <div className="space-y-6">
              <span className="font-serif text-3xl italic text-[#141414]">01.</span>
            ...
            <div className="space-y-6">
              <span className="font-serif text-3xl italic text-[#141414]">02.</span>
            ...
            <div className="space-y-6">
              <span className="font-serif text-3xl italic text-[#141414]">03.</span>
      ...
      <section className="py-32 md:py-48 px-6 md:px-24">
        <div className="max-w-screen-xl mx-auto grid md:grid-cols-2 gap-24 items-center">
          ...
          >
            <div>
              <span className="font-sans uppercase tracking-[0.4em] text-[10px] text-[#141414] mb-6 block">Der Fotograf</span>
              ...
              <button className="inline-flex items-center gap-4 group">
                ...
                <div className="w-12 h-12 rounded-full border border-[#141414]/10 flex items-center justify-center group-hover:bg-[#2d1e17] group-hover:text-white transition-all">
      ...
      {/* Testimonials - Deep Brown Section */}
      <section className="bg-[#2d1e17] text-white py-32 md:py-48 px-6 md:px-24 rounded-[4rem] mx-4 md:mx-8 mb-32">
        <div className="max-w-4xl mx-auto text-center">
          <span className="font-sans uppercase tracking-[0.4em] text-[10px] text-white/40 mb-12 block">Was Paare sagen</span>
      ...
      <section className="py-48 px-8 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex justify-center">
            <button className="bg-[#2d1e17] text-white px-12 py-6 rounded-full text-[10px] uppercase tracking-[0.3em] font-bold hover:scale-105 transition-transform">
