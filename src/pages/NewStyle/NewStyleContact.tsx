          ...
          >
            ...
            <div className="space-y-12">
              <div className="flex items-center gap-8 group cursor-pointer">
                ...
                <div>
                  <h4 className="text-[10px] uppercase tracking-widest font-bold text-[#a0522d] mb-1">Email</h4>
              ...
              <div className="flex items-center gap-8 group cursor-pointer">
                ...
                <div>
                  <h4 className="text-[10px] uppercase tracking-widest font-bold text-[#a0522d] mb-1">Instagram</h4>
              ...
              <div className="flex items-center gap-8 group cursor-pointer">
                ...
                <div>
                  <h4 className="text-[10px] uppercase tracking-widest font-bold text-[#a0522d] mb-1">Standort</h4>
            ...
            <form className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-2">
                  ...
                  <input type="email" className="w-full bg-transparent border-b border-[#141414]/10 py-4 outline-none focus:border-[#a0522d] transition-colors" placeholder="hello@example.com" />
                </div>
              </div>
              <div className="space-y-2">
                <label className="text-[10px] uppercase tracking-widest font-bold text-[#a0522d]">Eure Nachricht</label>
                <textarea rows={4} className="w-full bg-transparent border-b border-[#141414]/10 py-4 outline-none focus:border-[#a0522d] transition-colors resize-none" placeholder="Erzählt mir von euren Plänen..." />
              </div>
              <button className="w-full bg-[#1a2e26] text-white py-6 rounded-2xl font-bold uppercase tracking-widest text-xs hover:bg-[#a0522d] transition-colors flex items-center justify-center gap-3">
                Nachricht senden
                <Send size={14} />
              </button>
            </form>
