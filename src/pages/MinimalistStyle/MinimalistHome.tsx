      ...
      <section className="py-32 md:py-48 px-6 md:px-24 bg-[#f5f2ed] flex flex-col items-center">
        <div className="max-w-5xl w-full text-center">
          ...
          <div className="max-w-3xl mx-auto space-y-8">
            <p className="tracking-wide text-[#141414]/70 leading-relaxed text-base md:text-lg italic font-serif">
            ...
            <div className="flex flex-col items-center group pt-8">
              <span className="h-[1px] w-12 bg-[#141414]/20 group-hover:w-24 transition-all duration-500"></span>
            </div>
          </div>
        </div>
      </section>
