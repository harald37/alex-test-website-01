...
export const Testimonials = () => {
  ...
  return (
    <section className="relative min-h-[600px] md:h-[70vh] flex flex-col items-center justify-center overflow-hidden bg-zinc-900">
      {/* High-Resolution Background from User */}
      <div className="absolute inset-0 z-0">
        <img 
          src="https://lh3.googleusercontent.com/aida/ADBb0uiJazjLKVh1zAoqW_Qw_EE8btnkybn4g29qnzsrzgk8C03DQu0O4GGOvusC8bRhzHfvKhQeJK7Hd2tH861gtSmAjZ1v3VkJsWTJ2dT2hHL7kkT9hmXTIj272qsyKbG6k4SPgsn5LDny_GyxNmEh5JR0jsqvgZ00GrY0rpX1EtO95Uctm3ICUTANsAQKlti2EWCPn5fIeZSaT0clvkoW6IkYwJFZjht1eW8fCvRArso8DlSYyIRKbTk7A8e9xSp7JsWNzhk34eeO=s0" 
      ...
      <div className="relative z-10 max-w-screen-2xl mx-auto px-4 md:px-12 text-center text-white w-full">
        {/* Fixed height container for content to prevent jumping and overlapping */}
        <div className="h-[360px] md:h-[380px] flex flex-col items-center justify-center">
          <motion.div 
            initial={{ opacity: 0 }}
        ...
        {/* Progress Indicator - now stable below the fixed content area */}
