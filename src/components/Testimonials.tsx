...
export const Testimonials = () => {
  ...
  return (
    <section className="relative min-h-[600px] md:h-[70vh] flex flex-col items-center justify-center overflow-hidden bg-zinc-900">
      {/* High-Resolution Background from Portfolio */}
      ...
      <div className="relative z-10 max-w-screen-2xl mx-auto px-4 md:px-12 text-center text-white w-full flex flex-col items-center">
        {/* Header Elements - Stabilized at the top */}
        <div className="mb-8 md:mb-12">
          ...
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="font-sans uppercase tracking-[0.3em] text-[10px] md:text-xs text-white/60 font-light"
          >
            Das sagen meine Paare
          </motion.h2>
        </div>

        {/* Testimonial Content Area - Fixed height to prevent jumping */}
        <div className="flex items-center justify-center gap-2 md:gap-12 w-full max-w-5xl mx-auto">
          {/* Navigation Arrows */}
          <button 
            onClick={prev}
          ...
          <div className="flex items-center justify-center flex-1 h-[280px] md:h-[320px]">
